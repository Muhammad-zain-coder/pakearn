                              ...
                              <div class="table-responsive">
                                  <table class="table table-hover">
                                      ...
                                      <?php foreach ($users_data as $row) {
                                          ...
                                          $userMeta =  $db->query("Select * FROM users WHERE id={$row->user_id}");
                                          $results= $userMeta->getResult();
                                             ?>
                                          <tr>
                                              ...
                                              <td><?=$row->account?></td>
                                              <td><?=$row->amount?></td>
                                              <td><?=$results[0]->earnings?></td>
                                              <td><?=$results[0]->refrencer==null?0:$results[0]->refrencer?></td>


                                              <td><label class="badge badge-<?= $row->status=='unapproved'?'danger':'success'?>"><?=$row->status ?></label></td>
                                              <?php if($row->status=='unapproved'){ ?>
                                              <td><a href="<?php echo base_url('admin/widthrawalEdit/'.$row->id);?>"><i class="mdi mdi-pencil"></i></a></td><?php }?>
                                          </tr>
