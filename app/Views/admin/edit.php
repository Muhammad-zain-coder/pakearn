        ...
        <div class="col-md-4">
            <form method="post"  >
                <div class="mb-3">
                    ...
                    <input type="text" readonly class="form-control disabled" value="<?= $UserModel['username']?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Email</label>
                    <input type="text" readonly class="form-control disabled" value="<?= $UserModel['email']?>" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
